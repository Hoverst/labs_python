...
Нова умова: Кожен вид пива має свою ціну. Наша цільова функція тепер — мінімізувати загальну вартість закупленого пива, при цьому все ще виконавши обмеження (кожен працівник має отримати хоча б одне пиво, яке йому подобається)
